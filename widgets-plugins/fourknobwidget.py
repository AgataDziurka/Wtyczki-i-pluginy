...
class FourKnobWidget(QtGui.QWidget):

    moved = QtCore.pyqtSignal(int)

    def __init__(self, parent=None):

        super(FourKnobWidget, self).__init__(parent)

        self.setWindowTitle(QtCore.QObject.tr(self, "FourKnobWidget"))
        self.resize(200, 200)

        self._linecolor = QtGui.QColor(0, 0, 0)

        self._colorOUT = QtGui.QColor("black")
        self._colorOUTi = QtGui.QColor(126, 228, 110)
