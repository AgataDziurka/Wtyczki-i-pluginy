...
class MinusUpIndicatorWidget(QtGui.QWidget):

    def __init__(self, parent=None):

        super(MinusUpIndicatorWidget, self).__init__(parent)
        ...
        self.setWindowTitle(QtCore.QObject.tr(self, "MinusUpIndicatorWidget"))
        self.resize(100, 200)
    ...
    def paintEvent(self, event):
        ...
        if self._value == 0:
            ...
            self._position = 10 + ((self.height() - 20)*((self._value * 100)/self._minhigh)/100)
